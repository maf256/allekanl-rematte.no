export const Data = {
  ...
  home: {
    nr: {
      name: 'Johny Alnæs',
      h1: 'Pensjonert matematikklærer med lang erfaring og personlig oppfølging',
      h2: 'Privatundervisning som gjør matematikk forståelig og spennende',
      h3: 'Jeg er en engasjert matematikklærer med mange års erfaring fra klasserommet.',
      h4: 'Ta gjerne kontakt for en hyggelig samtale eller avtale om privatundervisning.',
    ...
    en: {
      name: 'Johny Alnæs',
      h1: 'Retired Math Teacher with Extensive Experience and Personalized Teaching',
      h2: 'Private Lessons that Make Math Understandable and Enjoyable',
      h3: 'I am a dedicated math teacher with many years of classroom experience.',
      h4: 'Feel free to reach out for a friendly conversation or to schedule private lessons.',
